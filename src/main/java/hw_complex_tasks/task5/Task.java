...
public class Task {
    ...
    // Система должна управлять доступом к складу через переменную isInventoryOpen и обрабатывать ситуации, когда товары заканчиваются, выбрасывая исключение OutOfStockException.
    //
