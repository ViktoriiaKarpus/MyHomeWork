...
public class Task2 {
     ...
     *
     * Описание:
     * Разработайте систему валидации для модели данных пользователя,
     * которая проверяет корректность имени, возраста и электронной почты.
     ...
     * Класс валидатора:
     * UserValidator: Сервис, который предоставляет методы для проверки объектов User
     * на соответствие определенным правилам.
     ...
     * Управление валидацией: Валидация данных должна происходить
     * только если флаг validationEnabled установлен в true.
